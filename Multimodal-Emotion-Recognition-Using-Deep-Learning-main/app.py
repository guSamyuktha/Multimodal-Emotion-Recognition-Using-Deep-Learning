...
import video_emotion_recognition
...
def video_feed():
    return Response(video_emotion_recognition.gen(), mimetype='multipart/x-mixed-replace; boundary=frame')
...
def live_data_multi():
    ...
    newdict = [{"name": "Video",
                "data": [{"name": "Angry", "value": round(video_data[0] * 100, 2)},
                         {"name": "Disgust", "value": round(video_data[1] * 100, 2)},
                         {"name": "Fearful", "value": round(video_data[2] * 100, 2)},
                         {"name": "Happy", "value": round(video_data[3] * 100, 2)},
                         {"name": "Neutral", "value": round(video_data[4] * 100, 2)},
                         {"name": "Sad", "value": round(video_data[5] * 100, 2)},
                         {"name": "Surprise", "value": round(video_data[6] * 100, 2)}]},
               {"name": "Audio",
